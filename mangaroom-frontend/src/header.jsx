        ...
        <BrowserRouter>
            <header className="flex sticky top-0 bg-neutral-800">
                ...
                <div className="flex flex-row uppercase font-medium ml-auto">
                    <Link to="/home" className="inline-flex items-center gap-2 p-3 hover:text-blue-400">
                        <HomeIcon className="h-5 w-5" />
                        Home
                    </Link>
                    <Link to="./on_air.jsx" className="inline-flex items-center gap-2 p-3 hover:text-blue-400">
                        <BookOpenIcon className="h-5 w-5" />
                        My Library
                    </Link>
                    <Link to="./settings.jsx" className="inline-flex items-center gap-2 p-3 hover:text-blue-400">
                        <Cog6ToothIcon className="h-5 w-5" />
                        Settings
                    </Link>
                    <Link to="./profile.jsx" className="inline-flex items-center gap-2 p-3 hover:text-blue-400">
